...
/** 
* @author yupeng
* @version 创建时间：2018年10月18日 下午8:24:13 
* 类说明 
*/
public class MyClass {
	...
	public static void main(String[] args) {
		...
		int[] datas = new int[]{2,4,12,45,21,6,111};
		List<Node> nodelist = new LinkedList<>();
		tree.creatBinaryTree(datas, nodelist);
		System.out.println(search(12).toString());
    ...
    public static Node search(int key) {
    	Node pNode = node;
        while (pNode != null && pNode.var != key) {
            if (key < pNode.var) {
                pNode = pNode.left;
            } else {
                pNode = pNode.right;
